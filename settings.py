...
servicesdict = {
            ...
            'L1OutPower': {'Service': "com.victronenergy.vebus.ttyO1",
                           ...
                           'Proxy': object,
                           'Value': 0},
            'L1SolarMaxPower': {'Service': "com.victronenergy.pvinverter.pv_77_1028251",
                                  'Path': "/Ac/MaxPower",
                                  'Proxy': object,
                                  'Value': 0},
            'L1SolarPower': {'Service': "com.victronenergy.pvinverter.pv_77_1028251",
                             'Path': "/Ac/Power",
                             'Proxy': object,
                             'Value': 0},
            'L1SolarPowerLimit':{'Service': "com.victronenergy.pvinverter.pv_77_1028251",
                             'Path': "/Ac/PowerLimit",
                             'Proxy': object,
                             'Value': 0},
